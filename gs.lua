...
-- UI Variables
if not isfolder("Nemesis") then
    makefolder("Nemesis")
end

if not isfolder("Nemesis/Configs") then
    makefolder("Nemesis/Configs")
end

if not isfolder("Nemesis/Images") then
    makefolder("Nemesis/Images")
end
local library = {
    drawings = {},
    objects = {},
    ...
    folders = {
        main = "Nemesis",
        assets = "Nemesis/Images",
        configs = "Nemesis/Configs"
    },
    shared = {
        initialized = false,
        fps = 0,
...
function utility:UpdatePreview(Pass)
    if (Nemesis.Locals.Window and Nemesis.Locals.Window.isVisible and Nemesis.Locals.SelectedPage == "Players") or Pass then
        if Nemesis.Locals.SelectedPage and Nemesis.Locals.SelectedPlayersSection then
            local Size = {0, 0}
            local Selection = ("Players" .. Nemesis.Locals.SelectedPlayersSection .. "_")
            --
            if Flags[Selection .. "Chams"]:Get() then
                ...
                --
                local ChamsAuto = Nemesis.Locals.SelectedPlayersSection ~= "Local" and Flags[Selection .. "ChamsAuto"]:Get()
                ...
                --
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Color", ChamsOutline, 1)
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 1 - ChamsOutlineTransparency, 1)
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Color", ChamsAuto and ((Nemesis.Locals.Window.VisualPreview.Visible) and ChamsVisible or ChamsHidden) or ChamsFill, 2)
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 1 - (ChamsAuto and ((Nemesis.Locals.Window.VisualPreview.Visible) and ChamsVisibleTransparency or ChamsHiddenTransparency) or ChamsFillTransparency), 2)
            else
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 0, 1)
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 0, 2)
            end
            --
            if Flags[Selection .. "Box"]:Get() then
                ...
                --
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Box", "Color", BoxColor)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Box", "Transparency", 1 - BoxTransparency)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Outline", "Transparency", 1 - BoxTransparency)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Fill", "Color", BoxFillColor)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Fill", "Transparency", 1 - BoxFillTransparency)
            else
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Box", "Transparency", 0)
            end
            --
            ...
            if Flags[Selection .. "HealthBar"]:Get() then
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Box", "Transparency", 1 - HealthBarTransparency)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Outline", "Transparency", 1 - HealthBarTransparency)
                --
                Size[1] = 5
            else
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("HealthBar", "Transparency", 0)
            end
            --
            if Flags[Selection .. "HealthNum"]:Get() or Flags[Selection .. "HealthBar"]:Get() then
                Nemesis.Locals.Window.VisualPreview.Color1 = HealthBarColor
                Nemesis.Locals.Window.VisualPreview.Color2 = HealthBarColor2
                --
                Nemesis.Locals.Window.VisualPreview:UpdateHealthBar()
            end
            --
            if Flags[Selection .. "HealthNum"]:Get() then
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Value", "Transparency", 1 - HealthBarTransparency or 0)
                --
                Nemesis.Locals.Window.VisualPreview:UpdateHealthValue(Size[1])
            else
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Value", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Name"]:Get() then
                ...
                --
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Title", "Text", "Color", NameColor)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Title", "Text", "Transparency", 1 - NameTransparency)
            else
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Title", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Distance"]:Get() then
                ...
                --
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Distance", "Text", "Color", DistanceColor)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Distance", "Text", "Transparency", 1 - DistanceTransparency)
            else
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Distance", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Tool"]:Get() then
                ...
                --
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Tool", "Text", "Color", ToolColor)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Tool", "Text", "Transparency", 1 - ToolTransparency)
            else
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Tool", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Flags"]:Get() then
                ...
                --
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Flags", "Text", "Color", FlagsColor)
                Nemesis.Locals.Window.VisualPreview:SetComponentSelfProperty("Flags", "Text", "Transparency", 1 - FlagsTransparency)
            else
                Nemesis.Locals.Window.VisualPreview:SetComponentProperty("Flags", "Transparency", 0)
            end
            --
            Nemesis.Locals.Window.VisualPreview:ValidateSize("X", Size[1])
        end
    end
end
--
utility:Connection(rs.Heartbeat, function()
    local Tick = tick()
    --
    if (Tick - Nemesis.Locals.LastPreviewUpdate) > 0.05 then
        utility:ThreadFunction(utility.UpdatePreview)
        Nemesis.Locals.LastPreviewUpdate = Tick
    end
end)
--

-- init configs
if isfolder("Nemesis/Configs") then
    for i,v in pairs(listfiles("Nemesis/Configs")) do
        table.insert(Nemesis.Configs, v:split("\\")[2]:split(".")[1])
    end
else
    makefolder("Nemesis/Configs")
end
...
--
Nemesis.Locals.ShiftTick = tick()
Nemesis.Locals.Shift = 0
--
function Nemesis:CheckTeam(Player1, Player2)
...
--
function Nemesis:GetHealth(Player, Character, Humanoid)
    if Humanoid then
        return Clamp(Humanoid.Health, 0, Humanoid.MaxHealth), Humanoid.MaxHealth
    end
end
function Nemesis:GetBodyParts(Character, RootPart, Indexes, Hitboxes)
    local Parts = {}
...
--
function Nemesis:ValidateClient(Player)
...
do -- utility
    ...
    function Library:RefreshConfigList()
        Flags["ConfigConfiguration_Box"].options = Nemesis.Configs
        Flags["ConfigConfiguration_Box"]:Refresh()
        Flags["ConfigConfiguration_Box"].current = Clamp(Flags["ConfigConfiguration_Box"].current, 0, #Nemesis.Configs)
    end
    --
    ...
    function Library:PerformConfigAction(ConfigName, Action)
        ...
        if ConfigName then
            if Action == "Delete" then
                local Found = Find(Nemesis.Configs, ConfigName)
                --
                if Found then
                    delfile(("Nemesis/Configs/%s"):format(ConfigName .. ".Nemesis"), Config)
                    Remove(Nemesis.Configs, Found) 
            ...
            elseif Action == "Save" then
                ...
                if Config then
                    ...
                    if not Find(Nemesis.Configs, ConfigName) then
                        print("Config not found")
                        writefile(("Nemesis/Configs/%s"):format(ConfigName .. ".Nemesis"), Config)
                        table.insert(Nemesis.Configs, ConfigName)
                        Library:RefreshConfigList()
                    end
                    --
                    writefile(("Nemesis/Configs/%s"):format(ConfigName .. ".Nemesis"), Config)
            ...
            elseif Action == "Load" then
                local Config = readfile(("Nemesis/Configs/%s"):format(ConfigName .. ".Nemesis"))
                local Table = Split(Config, "\n")
                local Table2 = {}
                --
                if Table[#Table] == "[ Nemesis ]" then
                    Remove(Table, #Table)
                end
                --
                for Index, Value in pairs(Table) do
    ...
    function Library:UpdateHue()
        if (tick() - Nemesis.Locals.ShiftTick) >= (1 / 60) then
            Nemesis.Locals.Shift = Nemesis.Locals.Shift + 0.01
            --
            ...
            elseif Flags["ConfigTheme_AccentEffect"]:Get() == "Shift" then
                ...
                --
                Library:UpdateColor("Accent", Color3.fromHSV(Math:Shift(Hue + (Math:Shift(Nemesis.Locals.Shift) * (Flags["ConfigTheme_EffectLength"]:Get() / 360))), Saturation, Value))
            elseif Flags["ConfigTheme_AccentEffect"]:Get() == "Reverse Shift" then
                local Hue, Saturation, Value = Flags["ConfigTheme_Accent"]:Get():ToHSV()
                --
                Library:UpdateColor("Accent", Color3.fromHSV(Math:Shift(Clamp(Hue - (Math:Shift(Nemesis.Locals.Shift) * (Flags["ConfigTheme_EffectLength"]:Get() / 360)), 0, 9999)), Saturation, Value))
            end
            --
            Nemesis.Locals.ShiftTick = tick()
        end
    ...
    function utility:ThreadFunction(Func, Name, ...)
        local Func = Name and function()
            ...
            --
            if not Passed and not Nemesis.Safe then
                warn("Nemesis:\n", "              " .. Name .. ":", Statement)
            end
        end or Func
    ...
    function utility:SafeCheck(Text)
        ...
        --
        for Index, Value in pairs(Nemesis.Locals.BadWords) do Safe = Safe:gsub(Value, "_") end
        --
        return Safe
    end
    --
    ...
    function utility:MousePosition(Offset)
        if Offset then
            return UserInputService:GetMouseLocation() + Nemesis:CursorOffset()
        else
